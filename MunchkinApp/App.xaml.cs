...
namespace MunchkinApp
{
    public partial class App : Application
    {
        ...
        private static bool mIsTrial = true;
        public bool IsTrial
        {
            get
            {
...
#else
            mIsTrial = LicenseInformation.IsTrial();
#endif
        }

        //public static MunchkinApp.ViewModel.ViewModel PlayerViewModel = new MunchkinApp.ViewModel.ViewModel();
        ...
        {           
            RootFrame.Navigate(new Uri("/RollDicePage.xaml", UriKind.Relative));
        }
    }
}